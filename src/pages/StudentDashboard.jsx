    ...
    <div className="absolute inset-0" style={{ perspective: '1000px' }}>
      ...
      <div className="absolute inset-0" style={{ transformStyle: 'preserve-3d', transform: 'rotateX(65deg) rotateY(10deg)' }}>
        ...
        >
          ...
          <div className="absolute bottom-0 right-1/2 w-2 h-2 bg-emerald-300 rounded-full -translate-y-1/2 translate-x-1/2 opacity-50" />
        </motion.div>
...
// ─── HARMONIZED FEATURE CARD ─────────────────────────────────────────────────
// Matches the exact elegant scale of Home.jsx
    ...
    <div className="min-h-screen bg-library-paper dark:bg-dark-bg text-library-primary dark:text-library-paper transition-colors duration-500 overflow-hidden" dir="rtl">
      ...
      <main className="relative z-10">
        ...
        <section className="relative w-full pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden border-b border-library-primary/[0.05] dark:border-white/[0.05]">
          {/* Subtle Aurora Background for harmony with landing page */}
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24 relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <DashboardCard 
              ...
              desc="تصفح جميع المراجع والكتب المتاحة للاستعارة من زملائك في مختلف الكليات." 
              icon={BookOpen} 
              to="/dashboard" 
              delay={0.1}
            />
            ...
            <DashboardCard 
              title="الملف الشخصي" 
              desc="قم بإدارة بياناتك الشخصية، تعديل صورتك، وتحديث معلومات التواصل." 
              icon={User} 
              to="/profile" 
              delay={0.2}
            />
            ...
            <DashboardCard 
              title="نسخي الخاصة" 
              desc="أضف كتبك الخاصة للمنصة، تحكم بحالتها، واجعلها متاحة لإفادة غيرك." 
              icon={Layers} 
              to="/my-copies" 
              delay={0.3}
            />
            ...
            <DashboardCard 
              ...
              desc="تابع طلبات الاستعارة، المواعيد النهائية للإرجاع، والكتب التي بحوزتك." 
              icon={Repeat} 
              to="/lending" 
              delay={0.4}
            />
